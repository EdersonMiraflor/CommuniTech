...
<div class="form-group">
    ...
    <input type="text" id="child_first_name" name="child_first" class="birth-form-control" placeholder="Enter child's first name" required>
    <input type="text" id="child_middle_name" name="child_middle" class="birth-form-control" placeholder="Enter child's middle name" required>
    <input type="text" id="child_last_name" name="child_last" class="birth-form-control" placeholder="Enter child's last name" required>
</div>
...
<div class="form-group">
    ...
    <input type="date" id="child_birthdate" name="child_birthdate" class="birth-form-control" max="" required>
    <span id="birthdate_error" style="color: red; display: none;">Date of birth cannot be in the future.</span>
</div>
...
<div class="form-group">
    ...
    <input type="text" id="mother_first_name" name="mother_first_name" class="birth-form-control" placeholder="Enter mother's first name" required>
    <input type="text" id="mother_middle_name" name="mother_middle_name" class="birth-form-control" placeholder="Enter mother's middle name" required>
    <input type="text" id="mother_last_name" name="mother_last_name" class="birth-form-control" placeholder="Enter mother's last name" required>
</div>
...
<div class="form-group">
    ...
    <input type="number" id="total_number" name="total_number" class="birth-form-control" required>
</div>

<div class="form-group">
    <label for="children" class="birth-label">10b. Number of children still living including this birth</label>
    <input type="number" id="children" name="children" class="birth-form-control" required>
</div>

<div class="form-group">
    <label for="dead_child" class="birth-label">10c. No. of children born alive but are now dead</label>
    <input type="number" id="dead_child" name="dead_child" class="birth-form-control" required>
</div>
...
<div class="form-group">
    ...
    <input type="number" id="mother_age" name="mother_age" class="birth-form-control" required>
</div>

<div class="form-group">
    <label for="mother_place" class="birth-label">13. Residence</label>
    <input type="text" id="mother_street" name="mother_street" class="birth-form-control" placeholder="House No./Street/Barangay" required>
    <input type="text" id="mother_city" name="mother_city" class="birth-form-control" placeholder="City/Municipality" required>
    <input type="text" id="mother_province" name="mother_province" class="birth-form-control" placeholder="Province" required>
    <input type="text" id="mother_country" name="mother_country" class="birth-form-control" placeholder="Country" required>
</div>

<h4>III. FATHER'S INFORMATION</h4>

<div class="form-group">
    <label for="father_name" class="birth-label">14. Father's Name</label>
    <input type="text" id="father_first_name" name="father_first_name" class="birth-form-control" placeholder="Enter father's first name" required>
...
<div class="form-group">
    <label for="citizenship2" class="birth-label">15. Citizenship</label>
    <input type="text" id="citizenship2" name="citizenship2" class="birth-form-control" required>
</div>

<div class="form-group">
    <label for="religion2" class="birth-label">16. Religion/Religious Sect</label>
    <input type="text" id="religion2" name="religion2" class="birth-form-control" required>
</div>

<div class="form-group">
    <label for="occupation2" class="birth-label">17. Occupation</label>
    <input type="text" id="occupation2" name="occupation2" class="birth-form-control" required>
</div>

<div class="form-group">
    <label for="father_age" class="birth-label">18. Age</label>
    <input type="number" id="father_age" name="father_age" class="birth-form-control" required>
</div>

<div class="form-group">
    <label for="father_place" class="birth-label">19. Residence</label>
    <input type="text" id="father_street" name="father_street" class="birth-form-control" placeholder="House No./Street/Barangay" required>
    <input type="text" id="father_city" name="father_city" class="birth-form-control" placeholder="City/Municipality" required>
    <input type="text" id="father_province" name="father_province" class="birth-form-control" placeholder="Province" required>
    <input type="text" id="father_country" name="father_country" class="birth-form-control" placeholder="Country" required>
</div>
...
<div class="form-group">
    ...
    <span id="marriage_date_error" style="color: red; display: none;">Date of marriage cannot be in the future.</span>
</div>

<div class="form-group">
    <label for="marriage_place" class="birth-label">20b. Place</label>
    <input type="text" id="marriage_street" name="marriage_street" class="birth-form-control" placeholder="House No./Street/Barangay" required>
    <input type="text" id="marriage_municipality" name="marriage_municipality" class="birth-form-control" placeholder="City/Municipality" required>
    <input type="text" id="marriage_province" name="marriage_province" class="birth-form-control" placeholder="Province" required>
    <input type="text" id="marriage_country" name="marriage_country" class="birth-form-control" placeholder="Country" required>
</div>
...
<script>
    ...
    document.getElementById('child_birthdate').addEventListener('change', function() {
    ...
    document.getElementById('marriage_date').addEventListener('change', function() {
        const today = new Date().toISOString().split('T')[0];
        if (this.value > today) {
            document.getElementById('marriage_date_error').style.display = 'block';
        } else {
            document.getElementById('marriage_date_error').style.display = 'none';
        }
    });

    // Show/hide additional input for attendant role
    document.getElementById('attendant_role').addEventListener('change', function() {
        const otherRole = document.getElementById('other_attendant_role');
        if (this.value === 'Other') {
...
<div class="container">
    <h4 class="text-center">AFFIDAVIT FOR ACKNOWLEDGMENT/ADMISSION OF PATERNITY</h4>
    <p> 
        I/We, 
        <div class="field">
        ...
        <input type="text" id="name_child" name="name_child" placeholder="Child's Name" required style="width: 60%;">
        , who was born on 
        <input type="date" id="birth_date" name="birth_date" required>
        at 
        <input type="text" id="birth_place" name="birth_place" placeholder="Place of Birth" required style="width: 50%;">
    </p>
    <p>
    ...
    <div class="form-group">
        <label for="father_signature" class="birth-label">Father's Name</label>
        <input type="text" id="father_signature" name="signature1" class="birth-form-control" placeholder="Enter father's signature" required>
    </div>
    <div class="form-group">
        <label for="mother_signature" class="birth-label">Mother's Name</label>
        <input type="text" id="mother_signature" name="signature2" class="birth-form-control" placeholder="Enter mother's signature" required>
    </div>
</div>
...
<script>
    ...
    document.getElementById('birth_date').addEventListener('change', function() {
        ...
        if (this.value > today) {
            ...
            this.value = ''; // Clear the field if the date is invalid
        }
    });
    ...
    document.querySelectorAll('input[type="date"]').forEach(input => {
        input.addEventListener('invalid', function() {
            this.setCustomValidity("Please provide a valid date.");
        });
        input.addEventListener('input', function() {
            this.setCustomValidity("");
        });
