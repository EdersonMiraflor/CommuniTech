    ...
    <div class="team-container">
        ...
        <div class="team-grid">
            <div class="team-member">
                <img src="{{ asset('img/romeoo.jpg') }}" alt="Project Manager">
                <p class="name">Romeo Banzuela</p>
                <p class="role">Project Manager</p>
            </div>
            <div class="team-member">
                <img src="{{ asset('img/princesss.jpg') }}" alt="System Analyst">
                <p class="name">Princess Malanyaon</p>
                <p class="role">System Analyst</p>
            </div>
            <div class="team-member">
                <img src="{{ asset('img/coleenn.png') }}" alt="Front-end Developer">
                <p class="name">Coleen Lustre</p>
                <p class="role">Front-end Developer</p>
            </div>
            <div class="team-member">
                <img src="{{ asset('img/ederr.png') }}" alt="Back-end Developer">
