...
<script>
    ...
    // Set the max date for both input fields
    document.getElementById("husband_birthdate").setAttribute("max", today);
    document.getElementById("wife_birthdate").setAttribute("max", today);
</script>
<script>
document.addEventListener("DOMContentLoaded", function() {
    ...
    const nameFields = document.querySelectorAll(
        ...
        '#husband_father_first_name, #husband_father_middle_name, #husband_father_last_name, ' +
        '#husband_father_citizenship, #husband_mother_first_name, #husband_mother_middle_name, ' +
        '#husband_mother_maiden_last_name, #husband_mother_citizenship, #wife_first_name, ' +
        '#wife_middle_name, #wife_last_name, #wife_city-municipality, #wife_province, ' +
        '#wife_country, #wife_citizenship, #wife_father_first_name, #wife_father_middle_name, ' +
        '#wife_father_last_name, #wife_father_citizenship, #wife_mother_first_name, ' +
        '#wife_mother_middle_name, #wife_mother_maiden_last_name, #wife_mother_citizenship, ' +
        '#officiant_name, #witnesses, #affiant_name, #marriage_registration_for, ' +
        '#spouse_name, #citizenship, #spouse_citizenship, #admin_officer_name'
    );
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    const ageFields = document.querySelectorAll('#husband_age, #wife_age');
