...
<div class="birth-container"> 
    ...
    <div class="form-group">
        ...
        <input type="date" id="husband_birthdate" name="husband_birthdate" class="birth-form-control" required onchange="validateDate(this)" />
    </div>

    <h3>2b. Age</h3>
    <div class="form-group">
        <label for="husband_age" class="birth-label">Age</label>
        <input type="number" id="husband_age" name="husband_age" class="birth-form-control" placeholder="Enter husband's age" required min="0" />
    </div>

    <h3>3. Place of Birth</h3>
    <div class="form-group">
        <label for="husband_city_municipality" class="birth-label">City/Municipality</label>
        <input type="text" id="husband_city_municipality" name="husband_city_municipality" class="birth-form-control" placeholder="Enter husband's City/Municipality" required />
    </div>
...
<div class="col-md-12">
    ...
    <div class="form-group">
        ...
        <input type="date" id="wife_birthdate" name="wife_birthdate" class="birth-form-control" required onchange="validateDate(this)" />
    </div>

    <h3>2b. Age</h3>    
    <div class="form-group">
        <label for="wife_age" class="birth-label">Age</label>
        <input type="number" id="wife_age" name="wife_age" class="birth-form-control" placeholder="Enter wife's age" required min="0" />
    </div>

    <h3>3. Place of Birth</h3>
    <div class="form-group">
        <label for="wife_city_municipality" class="birth-label">City/Municipality</label>
        <input type="text" id="wife_city_municipality" name="wife_city_municipality" class="birth-form-control" placeholder="Enter wife's City/Municipality" required />
    </div>
...
<div class="col-md-12">
    ...
    <div class="form-group">
        ...
        <input type="date" id="marriage_date1" name="marriage_date" class="birth-form-control" required onchange="validateDate(this)" />
    </div>
...
<div class="affidavit-section">
    ...
    <p>
        I, <input type="text" id="affiant_name" name="affiant_name" style="width: 300px;" placeholder="Name" required onblur="validateText(this, 'Name is required')">, of legal age, 
        ...
        <span class="error-message" id="civil_status_error"></span>, with residence and postal address 
        <input type="text" id="address" name="address" style="width: 500px;" placeholder="Address" required onblur="validateText(this, 'Address is required')">
    </p>
    <p>
    ...
    <ol>
        <li>
            ...
            <input type="text" id="marriage_registration_for" name="marriage_registration_for" style="width: 300px;" placeholder="Marriage Registration" required onblur="validateText(this, 'This field is required')"> 
            with my marriage with <input type="text" id="spouse_name" name="spouse_name" style="width: 300px;" placeholder="Spouse Name" required onblur="validateText(this, 'Spouse Name is required')"> 
            on <input type="date" id="marriage_date2" name="marriage_date2" style="width: 200px;" required onchange="validateDate(this)">
        </li>
        <li>
            That said marriage was solemnized by 
            <input type="text" id="solemnizing_officer" name="solemnizing_officer" style="width: 300px;" placeholder="Officer Name" required onblur="validateText(this, 'Officer Name is required')"> under
            <select id="ceremony_type" name="ceremony_type" required>
            ...
            <span class="error-message" id="ceremony_type_error"></span>.
        </li>
        <li>
            That the marriage was solemnized:
            <label><input type="radio" id="license_with" name="license_required" value="with_license" required onchange="toggleLicenseFields()"> with Marriage License No.</label>
            <input type="text" id="license_no" name="license_no" style="width: 200px;" placeholder="License No." onblur="validateText(this, 'License No. is required')"> issued on 
            <input type="date" id="license_date" name="license_date" style="width: 200px;" onchange="validateDate(this)"> at 
            <input type="text" id="license_place" name="license_place" style="width: 300px;" placeholder="Place of Issuance" onblur="validateText(this, 'Place of Issuance is required')">
            <br>
            <label><input type="radio" id="license_exception" name="license_required" value="exceptional_case" onchange="toggleLicenseFields()"> under Article 
            <input type="text" id="article_no" name="article_no" style="width: 200px;" placeholder="Article No." onblur="validateText(this, 'Article No. is required')"></label>.
        </li>
        <li>
            That I am a citizen of 
            <input type="text" id="citizenship" name="citizenship" style="width: 300px;" placeholder="Citizenship" required onblur="validateText(this, 'Citizenship is required')">, 
            and my spouse is a citizen of 
            <input type="text" id="spouse_citizenship" name="spouse_citizenship" style="width: 300px;" placeholder="Spouse Citizenship" required onblur="validateText(this, 'Spouse Citizenship is required')">.
        </li>
        <li>
            That the reason for the delay in registering the marriage is 
            <textarea id="delay_reason" name="delay_reason" style="width: 100%; height: 80px;" placeholder="Reason for delay" required onblur="validateText(this, 'Reason for delay is required')"></textarea>.
        </li>
        <li>
    ...
    <p>
        ...
        <input type="text" id="day2" name="day2" style="width: 50px;" placeholder="Day" required onblur="validateNumber(this, 'Valid day is required')"> day of 
        <input type="text" id="month2" name="month2" style="width: 150px;" placeholder="Month" required onblur="validateText(this, 'Valid month is required')">, 
        <input type="text" id="year2" name="year2" style="width: 100px;" placeholder="Year" required onblur="validateNumber(this, 'Valid year is required')">, 
        at <input type="text" id="location" name="location" style="width: 300px;" placeholder="Location" required onblur="validateText(this, 'Location is required')">.
    </p>
</div>
</form>
<script>
...
// Attach event listeners to the input fields to trigger validation when any field changes
const inputs = document.querySelectorAll('#executemarriagestore input');
...
function toggleLicenseFields() {
    ...
    const articleNo = document.getElementById('article_no');

    if (document.getElementById('license_with').checked) {
        licenseNo.disabled = false;
        articleNo.disabled = true;
    } else if (document.getElementById('license_exception').checked) {
        articleNo.disabled = false;
        licenseNo.disabled = true;
    }
}
