    ...
    <div class="row">
        ...
        <div class="col-12 col-md-6 right-container" style="background-color: #90D7A4; padding: 20px; border-radius: 8px;">
            ...
            <form action="/home/contact" method="POST">
                ...
                <input name="First_Name" type="text" placeholder="First Name" class="form-control" id="firstName" style=" font-size: 14px; padding: 8px; margin-bottom: 10px;">

                <!-- Surname -->
                <label for="lastName" class="form-label" style="font-size: 14px;">Surname</label>
                <input name="Last_Name" type="text" placeholder="Last Name" class="form-control" id="lastName" style=" font-size: 14px; padding: 8px; margin-bottom: 10px;">

                <!-- Email -->
                <label for="email" class="form-label" style="font-size: 14px;">Email</label>
                <input name="Email_Address" type="email" placeholder="Enter Email Address" class="form-control" id="email" style=" font-size: 14px; padding: 8px; margin-bottom: 10px;">

                <!-- Message -->
                <label for="message" class="form-label" style="font-size: 14px;">Message</label>
                <textarea name="Query" placeholder="Enter your message" class="form-control" id="message" style="font-size: 14px; padding: 8px; margin-bottom: 20px; height: 100px;"></textarea>

                <!-- Submit -->
                <button type="submit" class="btn w-100" style="background-color: #28a745; color: white; font-size: 14px; padding: 8px;">Submit</button>
            </form>
        </div>
    </div>
</div>
