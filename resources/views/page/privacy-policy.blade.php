                 ...
                 <div class="privacy-content1">
                     <h1><b>Privacy Policy</b></h1>
                      <p>Welcome to CommuniTECH, the dedicated platform for the citizens of Manito. 
                        ...
                        <p> At CommuniTECH, we are committed to safeguarding your privacy.
                             We ensure that all personal data collected is handled with the utmost care and transparency, adhering to legal and ethical standards. 
                            By using our platform, you agree to the practices described in this policy, designed to protect your information while delivering a seamless experience. </p>

                  </div>

                  <div class="right-content2">
                         <img src="{{ asset('img/policy.png') }}" alt="CommuniTech" class="policy-image">
                  </div>

                  <div class="privacy-content2">

                  <h2><strong>Information We Collect</strong></h2>
                               <ul>
                                        <li><strong>Personal information:</strong> When you register or apply for a vital record, we collect personal information such as your name, address, date of birth, contact information, and other relevant details.</li>
                                        <li><strong>Payment information:</strong> For processing payments through GCash, we collect payment information, including your GCash account number, payment method, and transaction information.</li>
                                        <li><strong>Device information:</strong> We may collect information about your device, including your IP address, browser type, and operating system to enhance your user experience.</li>
                                </ul>
                             ...
                             <h2><strong>Information Sharing and Disclosure</strong></h2>
                              <ul>
                                    ...
                                    <li>We may share your information with:</li>
                                     <ul>
                                            <li><strong>Manito Civil Registry Office:</strong> To process your application for vital records.</li>
                                            <li><strong>Payment Processors:</strong> To facilitate payments through GCash.</li>
                                            <li><strong></strong>Legal Authorities: When required by law or regulation.</li>
                                      </ul>
                              </ul>
                     ...
                     <h2><strong>Data Security</strong></h2>
                       ...
                       <ul>
                         ...
                         <p><strong>Address:</strong> Manito, Albay</p>
