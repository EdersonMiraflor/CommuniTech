...
/*Live Birth*/
    ...
    try{
        ...
        BirthCertificateRequest::create([
            ...
            'mother_street_input' => $request->mother_street_input,
            ...
            'father_street_input' => $request->father_street_input,
            ...
            'marriage_street_input' => $request->marriage_street_input,
        ...
        return redirect()->back()->with('error_input', 'Error: Incomplete or Invalid Input. Please ensure all required fields are completed correctly before proceeding.');
    }
}
/*End Live Birth*/
...
/*Marriage*/
    ...
    try{
        ...
        'husband_city' => $request->husband_city,
        'husband_city_input' => $request->husband_city_input,
        'husband_province' => $request->husband_province,
        'husband_province_input' => $request->husband_province_input,
        'husband_country' => $request->husband_country,
        'husband_country_input' => $request->husband_country_input,
        ...
        'wife_city' => $request->wife_city,
        'wife_city_input' => $request->wife_city_input,
        'wife_province' => $request->wife_province,
        'wife_province_input' => $request->wife_province_input,
        'wife_country' => $request->wife_country,
        'wife_country_input' => $request->wife_country_input,
        ...
        \Log::error($e->getMessage());
        return redirect()->back()->with('error_input2', 'Error: Incomplete or Invalid Input. Please ensure all required fields are completed correctly before proceeding.');
    }
}
/*End Marriage*/   
...
/*Death*/
    ...
    try{
        ...
        \Log::error($e->getMessage());
        return redirect()->back()->with('error_input3', 'Error: Incomplete or Invalid Input. Please ensure all required fields are completed correctly before proceeding.');
    }
}
/*End Death*/ 
}